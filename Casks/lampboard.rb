...
#
# Rendered by `Scripts/make-cask.sh` from a published release: 0.2.6 and
# f07217b180770de07980174af300087a0bae62dec847e0e86152ef95691d7e96 are the tag and the disk image's checksum. Two placeholders and
...
cask "lampboard" do
  version "0.2.6"
  sha256 "f07217b180770de07980174af300087a0bae62dec847e0e86152ef95691d7e96"
